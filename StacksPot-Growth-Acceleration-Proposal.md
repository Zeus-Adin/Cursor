...
To address this, StacksPot proposes a strategic partnership with the Stacks Endowment through a **Sponsored Pot Growth Accelerator Program**—a focused, **5-month** initiative designed to boost community pots with additional sBTC rewards, strengthen participation incentives, encourage more pot deployments, and increase overall ecosystem activity.
...
1. **Launch at full cadence** — establish the 8-pot / 2-week rhythm from Month 1  
2. **Sustain high participation** — keep all entry tiers live each cycle so users at every commitment level can join  
3. **Compound network effects** — 16 pots/month creates repeated touchpoints for wallets, communities, and builders  
4. **Measure retention** — a 5-month window is long enough to distinguish campaign spikes from lasting engagement  
...
Each sponsored pot introduces new users to Bitcoin-secured yield opportunities available through Stacks. Across **80 pots** in five months, that awareness compounds.
...
Delivered at the end of each program month (covering both 2-week cycles), including:
